...
{
    public class BinaryArraySerializer : IBinaryCustomSerialization
    {
        ...
        public BinaryArraySerializer(Type type, int maxLength, IBinaryCustomSerialization serializer)
        {
            MaxLength = maxLength;
