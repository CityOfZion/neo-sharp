...
{
    public class StructStackItem : ArrayStackItemBase, INativeStackItemContainer
    {
        ...
        public StructStackItem(Neo.VM.Types.Struct item) : base(true)
        {
            _item = item;
        }

        public StructStackItem(IEnumerable<StackItemBase> items = null) : base(true)
        {
